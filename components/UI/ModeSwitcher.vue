<template>
    <div>
        <div class="w-6 h-6 cursor-pointer" @click="toggleDarkMode">
            <svg v-if="isDark" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <svg v-else fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" class="stroke-slate-700 dark:stroke-slate-700">
