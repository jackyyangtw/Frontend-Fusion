<template>
  <div class="single-post-page container">
    <div class=" w-full md:w-[60%] lg:w-[750px] mx-auto">
      <section class="post">
        <h1 class="post-title text-sky-600 dark:text-purple-500 text-4xl font-black pb-3">{{ loadedPost.title }}</h1>
        <p class="post-content text-sky-400 dark:text-purple-300 text-xl font-light">{{ loadedPost.previewText }}</p>
